...
date: "`r doc_date()`"
package: "`r pkg_ver('PanVizGenerator')`"
abstract: >
...
provides both an easy and informative GUI (based on `r CRANpkg("shiny")`), as
...
`r Biocpkg("FindMyFriends")`. FindMyFriends provides functionality for adding
